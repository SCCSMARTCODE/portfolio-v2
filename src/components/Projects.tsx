...
import { Github, ExternalLink, Star, Code, Brain, Server, Globe } from "lucide-react";
...
const projects = [
    ...
    },
    {
        ...
        tags: ["C", "Socket Programming", "GTK", "System Engineering", "Network Programming"],
        category: "Systems",
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="mt-4 text-text-secondary max-w-2xl mx-auto">
                        A showcase of my latest work in AI, machine learning, and software engineering.
                    </p>
                </motion.div>
                    ...
                    <AnimatePresence>
                        {filteredProjects.map((project, index) => (
                            <motion.div
                                ...
                                key={project.title}
                                className={`group rounded-2xl bg-bg-glass border border-border-primary overflow-hidden hover:border-primary/50 transition-all hover:shadow-glow ${project.featured ? "md:col-span-2 lg:col-span-2 bg-gradient-to-br from-bg-glass to-primary/5" : ""
                                    }`}
                            >
