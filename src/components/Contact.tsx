        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-4">
              <a
                href="https://github.com/SCCSMARTCODE"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-lg bg-bg-secondary text-text-secondary hover:bg-primary hover:text-bg-primary transition-all"
              >
                <Github size={20} />
              </a>
              <a
                href="https://www.linkedin.com/in/sccsmartcode/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-lg bg-bg-secondary text-text-secondary hover:bg-primary hover:text-bg-primary transition-all"
              >
              ...
              <a
                href="https://www.youtube.com/channel/UC-KNjTsSQGokYvUsz74VVXg"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-lg bg-bg-secondary text-text-secondary hover:bg-primary hover:text-bg-primary transition-all"
              >
